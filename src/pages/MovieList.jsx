...
export default function MovieList() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6 flex flex-col items-center">
      <div style={movieID ? { backgroundImage: `url(https://image.tmdb.org/t/p/w1280/${filmes[movieID].backdrop_path})` } : { backgroundColor: 'black' }} className="h-[650px] pb-5 flex flex-col items-baseline justify-end overflow-x-scroll hide-scroll-bar bg-no-repeat bg-cover bg-center">
